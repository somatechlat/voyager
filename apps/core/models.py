...
Provides TimeStampedModel, TenantModel, UUIDModel as abstract base classes,
plus concrete AuditLog and SystemSetting models. All Voyager/Voyant models
should inherit from these to ensure consistent timestamp tracking, tenant
isolation, and UUID primary keys.
"""
...
class TimeStampedModel(models.Model):
    ...
    All Voyant models should inherit from this to ensure consistent
    timestamp tracking.
    """
...
class TenantModel(TimeStampedModel):
    ...
    All tenant-scoped models should inherit from this to ensure proper
    isolation.
    """
...
class AuditLog(TenantModel, UUIDModel):
    ...
    def __str__(self) -> str:
        return (
            f"{self.action} by {self.actor} on "
