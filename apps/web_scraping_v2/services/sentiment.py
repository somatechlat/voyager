...
POSITIVE_WORDS: set[str] = {
    ...
    "outstanding", "superb", "brilliant", "impressive", "nice", "beautiful",
    "easy", "smooth", "fast", "reliable", "helpful", "friendly", "professional",
}

NEGATIVE_WORDS: set[str] = {
    "bad", "terrible", "awful", "horrible", "hate", "worst", "poor",
    "disappointing", "frustrating", "annoying", "useless", "broken", "slow",
    "difficult", "expensive", "overpriced", "rude", "unprofessional",
    "disgusting", "messy", "dirty", "unreliable", "confusing", "complicated",
}
