"""
Voyager Security Configuration Module.
...
requirements for an enterprise marketing automation platform.
"""
...
class SecuritySettings(BaseSettings):
    """
    Security configuration for Voyager.

    These settings are designed to meet ISO/IEC 27001 security requirements
    and provide defense-in-depth security controls for enterprise marketing
    automation workloads.
    """

    model_config = SettingsConfigDict(
        env_prefix="VOYAGER_SECURITY_",
        env_file=".env",
